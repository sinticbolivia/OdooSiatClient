...
import {SiatSyncUnidadesMedida} from './sync_coms/sync_unidades_medida.js';
...
export class SiatSync extends Component
{
    ...
    setup()
    {
        ...
        this.menus = [
            ...
            {id: 3, label: 'Actividades Documento Sector', com: null},
            {id: 4, label: 'Leyendas Factura', 	com: SiatSyncLeyendas},
            {id: 5, label: 'Tipos Habitacion', com: null},
            ...
            {id: 9, label: 'Tipos Documento Identidad', com: null},
            {id: 10, label: 'Tipos Documento Sector', com: null},
            {id: 11, label: 'Tipos Emision', com: null},
            {id: 12, label: 'Tipos Metodo de Pago', com: SiatSyncMetodosPago},
            {id: 13, label: 'Tipos Moneda', com: null},
